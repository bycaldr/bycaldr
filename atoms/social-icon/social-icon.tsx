...
type Props = {
  type: "linkedin" | "medium" | "instagram";
};
...
export const SocialIcon = ({ type }: Props) => {
  if (type === "medium") return <MediumIcon />;
